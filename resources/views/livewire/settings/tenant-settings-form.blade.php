        ...
        <div class="card">
            <div class="card-body" style="display: grid; gap: 1rem; grid-template-columns: repeat(auto-fit, minmax(220px, 1fr));">
                <div>
                    ...
                    @error('currencyCode') <div class="text-danger">{{ $message }}</div> @enderror
                </div>
                <div>
                    ...
                    @error('taxRate') <div class="text-danger">{{ $message }}</div> @enderror
                </div>
                <div>
                    ...
                    @error('defaultBranchId') <div class="text-danger">{{ $message }}</div> @enderror
                </div>
                <div style="grid-column: 1 / -1;">
                    ...
                    @error('receiptHeader') <div class="text-danger">{{ $message }}</div> @enderror
                </div>
                <div style="grid-column: 1 / -1;">
                    ...
                    @error('receiptFooter') <div class="text-danger">{{ $message }}</div> @enderror
                </div>
            </div>
