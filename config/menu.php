...
return [
    ...
    /*
    |--------------------------------------------------------------------------
    | Pharmacy POS — Sidebar Menu Items
    |--------------------------------------------------------------------------
    |
    | Injected into Tyro Dashboard sidebars via View::composer in AppServiceProvider.
    | Items are filtered by the user's Tyro privileges at runtime.
    |
    */
